...
SDL_bool blocSeul(t_case *c) {
    return (
        EXISTE_VOISIN(c->tabVoisin[VOISIN_HAUT], c->tabVoisin[VOISIN_BAS], c->tabVoisin[VOISIN_GAUCHE], c->tabVoisin[VOISIN_DROIT]) 
...
SDL_bool angleDroit(t_case *c) {
    return (
        EXISTE_VOISIN(c->tabVoisin[VOISIN_HAUT], c->tabVoisin[VOISIN_DROIT])
        && (!(c->tabVoisin[VOISIN_HAUT]->val)) 
        && (
            (!c->tabVoisin[VOISIN_DROIT]->val) 
            || (
                (c->tabVoisin[VOISIN_DROIT]->val) 
                && EXISTE_VOISIN(c->tabVoisin[VOISIN_DIAG_DROIT_BAS])
...
SDL_bool angleGauche(t_case *c) {
    return (
        EXISTE_VOISIN(c->tabVoisin[VOISIN_HAUT],c->tabVoisin[VOISIN_GAUCHE])         
        && (!(c->tabVoisin[VOISIN_HAUT]->val))                                         
        && (
            (!(c->tabVoisin[VOISIN_GAUCHE]->val)) 
            || (
                (c->tabVoisin[VOISIN_GAUCHE]->val)
                && EXISTE_VOISIN(c->tabVoisin[VOISIN_DIAG_GAUCHE_BAS])
...
SDL_bool arrondiInferieurDroit(t_case *c) {
    return (
        EXISTE_VOISIN(c->tabVoisin[VOISIN_HAUT],c->tabVoisin[VOISIN_DIAG_DROIT_HAUT],c->tabVoisin[VOISIN_DROIT])
        && (c->tabVoisin[VOISIN_HAUT]->val) 
        && (c->tabVoisin[VOISIN_DROIT]->val) 
...
SDL_bool arrondiInferieurGauche(t_case *c) {
    return (
        EXISTE_VOISIN(c->tabVoisin[VOISIN_HAUT],c->tabVoisin[VOISIN_DIAG_GAUCHE_HAUT],c->tabVoisin[VOISIN_GAUCHE]) 
        && (c->tabVoisin[VOISIN_HAUT]->val) 
        && (c->tabVoisin[VOISIN_GAUCHE]->val) 
...
SDL_bool arrondiSuperieurDroit(t_case *c) {
    return (
        (EXISTE_VOISIN(c->tabVoisin[VOISIN_BAS],c->tabVoisin[VOISIN_DIAG_DROIT_BAS],c->tabVoisin[VOISIN_BAS2],c->tabVoisin[VOISIN_DIAG_GAUCHE_HAUT],c->tabVoisin[VOISIN_CENTRE_BAS2_DROIT]) 
            && (c->tabVoisin[VOISIN_DIAG_DROIT_BAS]->val) 
            && (c->tabVoisin[VOISIN_DIAG_GAUCHE_HAUT]->val)
            && (c->tabVoisin[VOISIN_BAS]->val) 
            && (c->tabVoisin[VOISIN_BAS2]->val) 
            && (!(c->tabVoisin[VOISIN_CENTRE_BAS2_DROIT]->val))
        )||(EXISTE_VOISIN(c->tabVoisin[VOISIN_BAS],c->tabVoisin[VOISIN_DIAG_DROIT_BAS],c->tabVoisin[VOISIN_BAS2],c->tabVoisin[VOISIN_CENTRE_BAS2_DROIT]) 
            && (c->tabVoisin[VOISIN_DIAG_DROIT_BAS]->val) 
...
SDL_bool arrondiSuperieurGauche(t_case *c) {
    return(
        (EXISTE_VOISIN(c->tabVoisin[VOISIN_BAS],c->tabVoisin[VOISIN_DIAG_GAUCHE_BAS],c->tabVoisin[VOISIN_DIAG_DROIT_HAUT],c->tabVoisin[VOISIN_BAS2],c->tabVoisin[VOISIN_CENTRE_BAS2_GAUCHE])
            && (c->tabVoisin[VOISIN_DIAG_GAUCHE_BAS]->val) 
            && (c->tabVoisin[VOISIN_BAS]->val) 
            && (c->tabVoisin[VOISIN_DIAG_DROIT_HAUT]->val)
            && (c->tabVoisin[VOISIN_BAS2]->val) 
            && (!(c->tabVoisin[VOISIN_CENTRE_BAS2_GAUCHE]->val))
        )||(EXISTE_VOISIN(c->tabVoisin[VOISIN_BAS],c->tabVoisin[VOISIN_DIAG_GAUCHE_BAS],c->tabVoisin[VOISIN_BAS2],c->tabVoisin[VOISIN_CENTRE_BAS2_GAUCHE]) 
            && (c->tabVoisin[VOISIN_DIAG_GAUCHE_BAS]->val) 
...
SDL_bool angleContinueGauche(t_case *c) {
    return (
        EXISTE_VOISIN(c->tabVoisin[VOISIN_BAS],c->tabVoisin[VOISIN_BAS2]) 
        && ((c->tabVoisin[VOISIN_BAS]->val)) 
        && (!(c->tabVoisin[VOISIN_BAS2]->val)) 
        && (
...
SDL_bool bordureMurGauche(t_case *c) {
    return (
        EXISTE_VOISIN(c->tabVoisin[VOISIN_DROIT])
        &&(
            ((!(c->tabVoisin[VOISIN_DROIT]->val))) 
            ||((EXISTE_VOISIN(c->tabVoisin[VOISIN_DIAG_DROIT_BAS])) &&((c->tabVoisin[VOISIN_DROIT]->val) && (!(c->tabVoisin[VOISIN_DIAG_DROIT_BAS]->val))))
        )
    );
}
...
SDL_bool bordureMurDroit(t_case *c) {
    return (
        EXISTE_VOISIN(c->tabVoisin[VOISIN_GAUCHE])
        &&( 
            ((!(c->tabVoisin[VOISIN_GAUCHE]->val))) 
            ||((EXISTE_VOISIN(c->tabVoisin[VOISIN_DIAG_GAUCHE_BAS])) &&((c->tabVoisin[VOISIN_GAUCHE]->val) && (!(c->tabVoisin[VOISIN_DIAG_GAUCHE_BAS]->val))))
        )
    );
}
